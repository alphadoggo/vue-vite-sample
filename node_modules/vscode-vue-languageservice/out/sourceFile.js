...
function createSourceFile(uri, _content, _version, context) {
    ...
    const version = (0, reactivity_1.ref)(-1);
    ...
    // computeds
    const document = (0, reactivity_1.computed)(() => vscode_languageserver_textdocument_1.TextDocument.create(uri, 'vue', version.value, content.value));
    ...
    const sfcScriptForTemplateLs = (0, useSfcScriptGen_1.useSfcScriptGen)('template', context.modules.typescript, uri, document, (0, reactivity_1.computed)(() => descriptor.script), (0, reactivity_1.computed)(() => descriptor.scriptSetup), (0, reactivity_1.computed)(() => sfcScript.ast.value), (0, reactivity_1.computed)(() => sfcScriptSetup.ast.value), sfcTemplateCompileResult, (0, reactivity_1.computed)(() => sfcStyles.textDocuments.value));
    const sfcScriptForScriptLs = (0, useSfcScriptGen_1.useSfcScriptGen)('script', context.modules.typescript, uri, document, (0, reactivity_1.computed)(() => descriptor.script), (0, reactivity_1.computed)(() => descriptor.scriptSetup), (0, reactivity_1.computed)(() => sfcScript.ast.value), (0, reactivity_1.computed)(() => sfcScriptSetup.ast.value), sfcTemplateCompileResult, (0, reactivity_1.computed)(() => sfcStyles.textDocuments.value));
    ...
    const sfcTemplateScript = (0, useSfcTemplateScript_1.useSfcTemplateScript)(uri, document, (0, reactivity_1.computed)(() => descriptor.template), (0, reactivity_1.computed)(() => descriptor.styles), templateScriptData, sfcStyles.textDocuments, sfcStyles.sourceMaps, sfcTemplateData, sfcTemplateCompileResult, (0, reactivity_1.computed)(() => sfcStyles.textDocuments.value), sfcScriptForScriptLs.lang, context);
    ...
    return {
        ...
        getScriptSetupData: (0, untrack_1.untrack)(() => sfcScriptForTemplateLs.scriptSetupRanges.value),
