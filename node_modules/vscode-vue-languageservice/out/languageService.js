...
function getDocumentLanguageService(modules, getPreferences, getFormatOptions, formatters) {
    ...
    function getVueDocument(document) {
        ...
        const vueDoc = (0, sourceFile_1.createSourceFile)(document.uri, document.getText(), document.version, context);
...
function createLanguageService(modules, vueHost, isTsPlugin = false) {
    ...
    function update(shouldUpdateTemplateScript) {
        ...
        if (newVueProjectVersion === undefined || newVueProjectVersion !== vueProjectVersion) {
            ...
            const newFiles = new Set([...vueHost.getScriptFileNames(), ...((_c = (_b = vueHost.getExternalScriptFileNames) === null || _b === void 0 ? void 0 : _b.call(vueHost)) !== null && _c !== void 0 ? _c : [])]);
            const removes = [];
            const adds = [];
            const updates = [];
    ...
    function updateSourceFiles(uris, shouldUpdateTemplateScript) {
        ...
        for (const uri of uris) {
            ...
            if (!doc)
                continue;
            if (!sourceFile) {
                sourceFiles.set(uri, (0, sourceFile_1.createSourceFile)(doc.uri, doc.getText(), doc.version, context));
