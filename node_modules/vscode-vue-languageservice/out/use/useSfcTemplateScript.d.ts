...
export declare function useSfcTemplateScript(vueUri: string, vueDoc: Ref<TextDocument>, template: Ref<shared.Sfc['template']>, styles: Ref<shared.Sfc['styles']>, templateScriptData: ITemplateScriptData, styleDocuments: Ref<{
