...
export declare function createSourceFile(uri: string, _content: string, _version: number, context: LanguageServiceContext): {
    uri: string;
    ...
    update: (newContent: string, newVersion: number) => {
